...
h qregless[7];
x qregless[8];
cp(2.6875343403756435) qregless[8],qregless[0];
cp(-0.9081166264282996) qregless[8],qregless[1];
cp(-1.8162332528565992) qregless[8],qregless[2];
cp(2.650718801466388) qregless[8],qregless[3];
cp(-5*pi/16) qregless[8],qregless[4];
cp(-5*pi/8) qregless[8],qregless[5];

...
h qregless[7];
x qregless[8];
cp(-2.6998061866787286) qregless[8],qregless[0];
cp(0.8835729338221293) qregless[8],qregless[1];
cp(9*pi/16) qregless[8],qregless[2];
cp(-7*pi/8) qregless[8],qregless[3];
cp(pi/4) qregless[8],qregless[4];
cp(pi/2) qregless[8],qregless[5];

...
u2(0,-pi) qregless[3];
u2(0,-pi) qregless[4];
u3(0.9272952180016122,0,0) qregless[5];
cx qregless[0],qregless[5];
u(-0.9272952180016122,0,0) qregless[5];
cx qregless[0],qregless[5];
u3(0.9272952180016122,0,0) qregless[5];
cx qregless[1],qregless[5];
u(-1.8545904360032244,0,0) qregless[5];
cx qregless[1],qregless[5];
u3(1.8545904360032242,0,0) qregless[5];
rzz(7*pi/4) qregless[2],qregless[5];
u(-3.7091808720064487,0,0) qregless[5];
cx qregless[2],qregless[5];
u3(2.574004435173138,-pi,-pi) qregless[5];
cx qregless[3],qregless[5];
u(-7.4183617440128975,0,0) qregless[5];
cx qregless[3],qregless[5];
u3(1.135176436833311,0,0) qregless[5];
cx qregless[4],qregless[5];
u(-14.836723488025795,0,0) qregless[5];
cx qregless[4],qregless[5];
u(14.836723488025795,0,0) qregless[5];
h qregless[4];

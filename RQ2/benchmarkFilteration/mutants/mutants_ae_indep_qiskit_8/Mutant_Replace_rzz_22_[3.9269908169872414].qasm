...
u2(0,-pi) qregless[5];
u2(0,-pi) qregless[6];
u3(0.9272952180016122,0,0) qregless[7];
cx qregless[0],qregless[7];
u(-0.9272952180016122,0,0) qregless[7];
cx qregless[0],qregless[7];
u3(0.9272952180016122,0,0) qregless[7];
cx qregless[1],qregless[7];
u(-1.8545904360032244,0,0) qregless[7];
cx qregless[1],qregless[7];
u3(1.8545904360032242,0,0) qregless[7];
cx qregless[2],qregless[7];
u(-3.7091808720064487,0,0) qregless[7];
cx qregless[2],qregless[7];
u3(2.574004435173138,-pi,-pi) qregless[7];
cx qregless[3],qregless[7];
u(-7.4183617440128975,0,0) qregless[7];
rzz(5*pi/4) qregless[3],qregless[7];
u3(1.135176436833311,0,0) qregless[7];
cx qregless[4],qregless[7];
u(-14.836723488025795,0,0) qregless[7];
cx qregless[4],qregless[7];
u3(2.270352873666622,0,0) qregless[7];
cx qregless[5],qregless[7];
u(-29.67344697605159,0,0) qregless[7];
cx qregless[5],qregless[7];
u3(1.7424795598463425,-pi,-pi) qregless[7];
cx qregless[6],qregless[7];
u(-59.34689395210318,0,0) qregless[7];
cx qregless[6],qregless[7];
u(59.34689395210318,0,0) qregless[7];
h qregless[6];

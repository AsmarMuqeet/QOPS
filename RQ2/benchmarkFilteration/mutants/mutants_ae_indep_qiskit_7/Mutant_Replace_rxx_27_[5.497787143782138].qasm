...
u2(0,-pi) qregless[4];
u2(0,-pi) qregless[5];
u3(0.9272952180016122,0,0) qregless[6];
cx qregless[0],qregless[6];
u(-0.9272952180016122,0,0) qregless[6];
cx qregless[0],qregless[6];
u3(0.9272952180016122,0,0) qregless[6];
cx qregless[1],qregless[6];
u(-1.8545904360032244,0,0) qregless[6];
cx qregless[1],qregless[6];
u3(1.8545904360032242,0,0) qregless[6];
cx qregless[2],qregless[6];
u(-3.7091808720064487,0,0) qregless[6];
cx qregless[2],qregless[6];
u3(2.574004435173138,-pi,-pi) qregless[6];
cx qregless[3],qregless[6];
u(-7.4183617440128975,0,0) qregless[6];
cx qregless[3],qregless[6];
u3(1.135176436833311,0,0) qregless[6];
cx qregless[4],qregless[6];
u(-14.836723488025795,0,0) qregless[6];
cx qregless[4],qregless[6];
u3(2.270352873666622,0,0) qregless[6];
rxx(7*pi/4) qregless[5],qregless[6];
u(-29.67344697605159,0,0) qregless[6];
